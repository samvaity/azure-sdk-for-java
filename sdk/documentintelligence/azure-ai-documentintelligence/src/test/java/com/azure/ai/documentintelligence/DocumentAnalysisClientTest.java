...
import com.azure.ai.documentintelligence.administration.DocumentModelAdministrationClient;
...
import com.azure.ai.documentintelligence.administration.models.DocumentModelBuildMode;
import com.azure.ai.documentintelligence.administration.models.DocumentModelDetails;
...
import static com.azure.ai.documentintelligence.TestUtils.INVALID_URL;
import static com.azure.ai.documentintelligence.TestUtils.INVOICE_6_PDF;
import static com.azure.ai.documentintelligence.TestUtils.INVOICE_NO_SUB_LINE_PDF;
...
public class DocumentAnalysisClientTest extends DocumentAnalysisClientTestBase {
    ...
    @MethodSource("com.azure.ai.documentintelligence.TestUtils#getTestParameters")
    @Disabled("until service regression is fixed #33187")
    public void invoiceSubLineItemsNull(HttpClient httpClient, DocumentIntelligenceServiceVersion serviceVersion) {
        client = getDocumentAnalysisClient(httpClient, serviceVersion);
        dataRunner((data, dataLength) -> {
    ...
    public void analyzeDataWithInvalidLength(HttpClient httpClient, DocumentIntelligenceServiceVersion serviceVersion) {
        client = getDocumentAnalysisClient(httpClient, serviceVersion);
        dataRunner((data, dataLength) -> {
