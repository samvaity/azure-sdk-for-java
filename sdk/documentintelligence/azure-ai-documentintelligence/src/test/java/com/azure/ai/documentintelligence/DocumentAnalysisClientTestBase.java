...
import static com.azure.ai.documentintelligence.TestUtils.AZURE_FORM_RECOGNIZER_ENDPOINT_CONFIGURATION;
...
//                setMatchers();
//            } else if (interceptorManager.isRecordMode()) {
//                builder.credential(getCredentialByAuthority());
//                builder.addPolicy(interceptorManager.getRecordPolicy());
//            } else if (interceptorManager.isLiveMode()) {
//                builder.credential(getCredentialByAuthority());
//            }
...
//            }
    ...
    void validateBusinessCardData(AnalyzeResult analyzeResult) {
        ...
        assertEquals("2 Kingdom Street",
            actualBusinessCardFields.get("Addresses").getValueArray().get(0).getValueAddress().getStreetAddress());
        assertNotNull(actualBusinessCardFields.get("Addresses").getValueArray().get(0).getConfidence());
        assertEquals(EXPECTED_MERCHANT_NAME, actualBusinessCardFields.get("CompanyNames")
            .getValueArray().get(0).getValueString());
        assertNotNull(actualBusinessCardFields.get("CompanyNames").getValueArray().get(0).getConfidence());
        assertEquals("Cloud & Al Department", actualBusinessCardFields.get("Departments")
            .getValueArray().get(0).getValueString());
        assertNotNull(actualBusinessCardFields.get("Departments").getValueArray().get(0).getConfidence());
        assertEquals("avery.smith@contoso.com", actualBusinessCardFields.get("Emails")
            .getValueArray().get(0).getValueString());
        assertNotNull(actualBusinessCardFields.get("Emails").getValueArray().get(0).getConfidence());
        assertEquals(DocumentFieldType.PHONE_NUMBER, actualBusinessCardFields.get("Faxes")
            .getValueArray().get(0).getType());
        assertNotNull(actualBusinessCardFields.get("Faxes").getValueArray().get(0).getConfidence());
        assertEquals("Senior Researcher", actualBusinessCardFields.get("JobTitles")
            .getValueArray().get(0).getValueString());
        assertNotNull(actualBusinessCardFields.get("JobTitles").getValueArray().get(0).getConfidence());
        assertEquals(DocumentFieldType.PHONE_NUMBER, actualBusinessCardFields.get("MobilePhones")
            .getValueArray().get(0).getType());
        assertNotNull(actualBusinessCardFields.get("MobilePhones").getValueArray().get(0).getConfidence());
        assertEquals("https://www.contoso.com/", actualBusinessCardFields.get("Websites")
            .getValueArray().get(0).getValueString());
        assertNotNull(actualBusinessCardFields.get("Websites").getValueArray().get(0).getConfidence());
        assertEquals(DocumentFieldType.PHONE_NUMBER, actualBusinessCardFields.get("WorkPhones")
            .getValueArray().get(0).getType());
        assertNotNull(actualBusinessCardFields.get("WorkPhones").getValueArray().get(0).getConfidence());
        Map<String, DocumentField> contactNamesMap
            = actualBusinessCardFields.get("ContactNames").getValueArray().get(0).getValueObject();
    ...
    static void validateMultipageBusinessData(AnalyzeResult analyzeResult) {
        ...
        List<DocumentField> emailList = businessCard1Fields.get("Emails").getValueArray();
        assertEquals("johnsinger@contoso.com", emailList.get(0).getValueString());
        assertNotNull(emailList.get(0).getConfidence());
        List<DocumentField> phoneNumberList = businessCard1Fields.get("WorkPhones").getValueArray();
        ...
        DocumentField contactNameField = businessCard1Fields.get("ContactNames").getValueArray().get(0);
        ...
        List<DocumentField> email2List = businessCard2Fields.get("Emails").getValueArray();
        assertEquals("avery.smith@contoso.com", email2List.get(0).getValueString());
        assertNotNull(email2List.get(0).getConfidence());
        List<DocumentField> phoneNumber2List = businessCard2Fields.get("WorkPhones").getValueArray();
        assertEquals("+44 (0) 20 9876 5432", phoneNumber2List.get(0).getContent());
        assertNotNull(phoneNumber2List.get(0).getConfidence());

        // assert contact name page number
        DocumentField contactName2Field = businessCard2Fields.get("ContactNames").getValueArray().get(0);
    ...
    void validateInvoiceData(AnalyzeResult analyzeResult) {
        ...
        CurrencyValue subtotal =
            subtotalField.getValueCurrency();
    ...
    static void validateMultipageInvoiceData(AnalyzeResult analyzeResult) {
        ...
        assertEquals("2345 Dogwood Lane", remittanceAddress.getValueAddress().getStreetAddress());
    ...
    void validateSelectionMarkContentData(AnalyzeResult analyzeResult) {
        ...
        analyzeResult.getPages().forEach(documentPage -> {
            ...
            for (int i = 0; i < selectionMarks.size(); i++) {
                ...
                validateBoundingBoxData(documentSelectionMark.getPolygon());
                assertNotNull(documentSelectionMark.getState());
                if (i == 0) {
                    Assertions.assertEquals(DocumentSelectionMarkState.UNSELECTED, documentSelectionMark.getState());
                } else if (i == 1) {
                    assertEquals(DocumentSelectionMarkState.SELECTED, documentSelectionMark.getState());
                } else {
                    assertEquals(DocumentSelectionMarkState.UNSELECTED, documentSelectionMark.getState());
                }
            }
        });
        ...
        analyzeResult.getDocuments().forEach(actualDocument ->
            actualDocument.getFields().forEach((key, documentField) -> {
                if ("AMEX_SELECTION_MARK".equals(key)) {
                    assertEquals(DocumentSelectionMarkState.SELECTED, documentField.getValueSelectionMark());
                } else if ("VISA_SELECTION_MARK".equals(key)) {
                    assertEquals(DocumentSelectionMarkState.UNSELECTED, documentField.getValueSelectionMark());
    ...
    void validateW2Data(AnalyzeResult analyzeResult) {
        ...
        Assertions.assertEquals(3894.54f, w2Fields.get("FederalIncomeTaxWithheld").getValueNumber());
        assertEquals(9873.2f, w2Fields.get("DependentCareBenefits").getValueNumber());
    ...
    private void validatePngReceiptFields(Map<String, DocumentField> actualFields) {
        Assertions.assertEquals("+19876543210", actualFields.get("MerchantPhoneNumber").getValuePhoneNumber());
        assertNotNull(actualFields.get("Subtotal").getValueNumber());
        assertNotNull(actualFields.get("Total").getValueNumber());
        ...
        List<DocumentField> itemizedItems = actualFields.get("Items").getValueArray();
        ...
        for (int i = 0; i < itemizedItems.size(); i++) {
            if (itemizedItems.get(i).getContent() != null) {
                ...
                Map<String, DocumentField> actualReceiptItems = itemizedItems.get(i).getValueObject();
                int finalI = i;
    ...
    private void validateJpegReceiptFields(Map<String, DocumentField> actualFields) {
        actualFields.forEach((key, documentField) -> {
            ...
            if ("Locale".equals(key)) {
                ...
                Assertions.assertEquals(11.7f, documentField.getValueNumber());
                assertNotNull(documentField.getConfidence());
            } else if ("Tax".equals(key)) {
                Assertions.assertEquals(1.17f, documentField.getValueNumber());
                assertNotNull(documentField.getConfidence());
            } else if ("Tip".equals(key)) {
                Assertions.assertEquals(1.63f, documentField.getValueNumber());
                assertNotNull(documentField.getConfidence());
                ...
                Assertions.assertEquals(14.5f, documentField.getValueNumber());
                assertNotNull(documentField.getConfidence());
            }
        });
    }
