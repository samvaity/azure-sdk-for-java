...
public final class SelectionMarkState extends ExpandableStringEnum<SelectionMarkState> {
    ...
    @Generated public static final SelectionMarkState SELECTED = fromString("selected");

    /** The selection mark is not selected. */
    @Generated public static final SelectionMarkState UNSELECTED = fromString("unselected");
