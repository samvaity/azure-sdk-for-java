...
public final class OperationKind extends ExpandableStringEnum<OperationKind> {
    ...
    @Generated public static final OperationKind DOCUMENT_MODEL_BUILD = fromString("documentModelBuild");

    /** Compose a new custom document model from existing models. */
    @Generated public static final OperationKind DOCUMENT_MODEL_COMPOSE = fromString("documentModelCompose");

    /** Copy an existing document model to potentially a different resource, region, or subscription. */
    @Generated public static final OperationKind DOCUMENT_MODEL_COPY_TO = fromString("documentModelCopyTo");

    /** Build a new custom classifier model. */
    @Generated public static final OperationKind DOCUMENT_CLASSIFIER_BUILD = fromString("documentClassifierBuild");
