...
public final class DocumentFormula {
    ...
    private DocumentFormula(
            @JsonProperty(value = "kind") DocumentFormulaKind kind,
    ...
    /**
     * Get the polygon property: Bounding polygon of the formula, with coordinates specified relative to the top-left of
