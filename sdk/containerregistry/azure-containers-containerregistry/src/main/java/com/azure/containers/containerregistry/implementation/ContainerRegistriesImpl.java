...
public final class ContainerRegistriesImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<String> getRepositoriesSync(String last, Integer n) {
        return new PagedIterable<>(
                () -> getRepositoriesSyncSinglePage(last, n, Context.NONE),
                nextLink -> getRepositoriesNextSyncSinglePage(nextLink, Context.NONE));
    }
    ...
    public PagedIterable<TagAttributesBase> getTagsSync(
            String name, String last, Integer n, String orderBy, String digest) {
        return new PagedIterable<>(
                () -> getTagsSyncSinglePage(name, last, n, orderBy, digest, Context.NONE),
                nextLink -> getTagsNextSyncSinglePage(nextLink, Context.NONE));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManifestAttributesBase> getManifestsSync(String name, String last, Integer n, String orderBy) {
        return new PagedIterable<>(
                () -> getManifestsSyncSinglePage(name, last, n, orderBy, Context.NONE),
                nextLink -> getManifestsNextSyncSinglePage(nextLink, Context.NONE));
    }
