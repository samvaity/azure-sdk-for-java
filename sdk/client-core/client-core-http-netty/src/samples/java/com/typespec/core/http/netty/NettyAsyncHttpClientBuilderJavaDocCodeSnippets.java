...
public class NettyAsyncHttpClientBuilderJavaDocCodeSnippets {
    ...
    public void simpleInstantiation() {
        // BEGIN: com.typespec.core.http.netty.instantiation-simple
    ...
    public void fixedThreadPoolSample() {
        // BEGIN: com.typespec.core.http.netty.NettyAsyncHttpClientBuilder#eventLoopGroup
        int threadCount = 5;
        HttpClient client = new NettyAsyncHttpClientBuilder()
    ...
    public void connectionProviderSample() {
        // BEGIN: com.typespec.core.http.netty.NettyAsyncHttpClientBuilder.connectionProvider#ConnectionProvider
    ...
    public void proxySample() {
        // BEGIN: com.typespec.core.http.netty.NettyAsyncHttpClientBuilder#proxy
        HttpClient client = new NettyAsyncHttpClientBuilder()
            .proxy(new ProxyOptions(ProxyOptions.Type.HTTP, new InetSocketAddress("<proxy-host>", 8888)))
            .build();
        // END: com.typespec.core.http.netty.NettyAsyncHttpClientBuilder#proxy
    }
    ...
    public void fromExistingReactorNettyClient() {
        // BEGIN: com.typespec.core.http.netty.from-existing-http-client
    ...
    public void disabledBufferCopyClientSample() {
        ...
        // BEGIN: com.typespec.core.http.netty.disabled-buffer-copy
        HttpClient client = new NettyAsyncHttpClientBuilder()
            .port(8080)
