...
/**
 * Class containing all ChannelHandler concepts that the TypeSpec SDKs use.
 * <p>
 ...
 */
public final class TypeSpecSdkHandler extends ChannelDuplexHandler {
    /**
     * Name of the handler when it's added into a ChannelPipeline.
     */
    public static final String HANDLER_NAME = "TypeSpecSdkHandler";
     ...
     * write progress.
     *
     * @param context Per-request context passed by the TypeSpec SDK.
     ...
     */
    public TypeSpecSdkHandler(TypeSpecNettyHttpClientContext context, long writeTimeoutMillis, long responseTimeoutMillis,
