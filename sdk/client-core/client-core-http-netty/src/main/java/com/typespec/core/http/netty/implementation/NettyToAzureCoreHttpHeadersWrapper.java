...
package com.typespec.core.http.netty.implementation;
...
// This class wraps a Netty HttpHeaders instance and provides an typespec-core HttpHeaders view onto it.
// This avoids the need to copy the Netty HttpHeaders into an typespec-core HttpHeaders instance.
...
public class NettyToTypeSpecCoreHttpHeadersWrapper extends HttpHeaders {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NettyToTypeSpecCoreHttpHeadersWrapper.class);
    ...
    public NettyToTypeSpecCoreHttpHeadersWrapper(io.netty.handler.codec.http.HttpHeaders nettyHeaders) {
    ...
    public HttpHeader get(String name) {
        ...
        // Netty HttpHeaders uses List<String>, whereas typespec-core HttpHeaders joins it all into a comma-separated
    ...
    static class NettyHttpHeader extends HttpHeader {
        private final NettyToTypeSpecCoreHttpHeadersWrapper allHeaders;

        NettyHttpHeader(NettyToTypeSpecCoreHttpHeadersWrapper allHeaders, String name, String value) {
            super(name, value);
            this.allHeaders = allHeaders;
        }

        NettyHttpHeader(NettyToTypeSpecCoreHttpHeadersWrapper allHeaders, String name, List<String> values) {
            super(name, values);
            this.allHeaders = allHeaders;
        }
    ...
    static final class NettyHeadersIterator implements Iterator<HttpHeader> {
        ...
        NettyHeadersIterator(NettyToTypeSpecCoreHttpHeadersWrapper allHeaders) {
            this.allHeaders = allHeaders;
