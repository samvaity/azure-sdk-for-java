 ...
 */
public final class TypeSpecNettyHttpClientContext {
    public static final String KEY = "typespec-sdk-pipeline-data";
    private final Long responseTimeoutOverride;
    private final ProgressReporter progressReporter;

    public TypeSpecNettyHttpClientContext(Long responseTimeoutOverride, ProgressReporter progressReporter) {
