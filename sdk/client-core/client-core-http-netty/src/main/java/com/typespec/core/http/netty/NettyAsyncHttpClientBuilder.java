...
package com.typespec.core.http.netty;

import com.typespec.core.http.HttpRequest;
import com.typespec.core.http.ProxyOptions;
import com.typespec.core.http.netty.implementation.TypeSpecNettyHttpClientContext;
import com.typespec.core.http.netty.implementation.TypeSpecSdkHandler;
import com.typespec.core.http.netty.implementation.ChallengeHolder;
import com.typespec.core.http.netty.implementation.HttpProxyHandler;
import com.typespec.core.util.AuthorizationChallengeHandler;
...
import static com.typespec.core.util.Configuration.PROPERTY_TypeSpec_REQUEST_CONNECT_TIMEOUT;
import static com.typespec.core.util.Configuration.PROPERTY_TypeSpec_REQUEST_READ_TIMEOUT;
import static com.typespec.core.util.Configuration.PROPERTY_TypeSpec_REQUEST_RESPONSE_TIMEOUT;
import static com.typespec.core.util.Configuration.PROPERTY_TypeSpec_REQUEST_WRITE_TIMEOUT;
import static com.typespec.core.util.CoreUtils.getDefaultTimeoutFromEnvironment;

/**
 * Builder class responsible for creating instances of {@link com.typespec.core.http.HttpClient} backed by Reactor Netty.
 * Please be aware that client built from this builder can support synchronously and asynchronously call of sending
 * request. Use {@link com.typespec.core.http.HttpClient#sendSync(HttpRequest, Context)} to send the provided request
 * synchronously with contextual information.
 *
 * <p><strong>Building a new HttpClient instance</strong></p>
 *
 * <!-- src_embed com.typespec.core.http.netty.instantiation-simple -->
 * <pre>
 ...
 *     .build&#40;&#41;;
 * </pre>
 * <!-- end com.typespec.core.http.netty.instantiation-simple -->
 *
 * @see HttpClient
 */
public class NettyAsyncHttpClientBuilder {
    ...
    static {
        ...
        DEFAULT_CONNECT_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration,
            PROPERTY_TypeSpec_REQUEST_CONNECT_TIMEOUT, Duration.ofSeconds(10), LOGGER).toMillis();
        DEFAULT_WRITE_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration, PROPERTY_TypeSpec_REQUEST_WRITE_TIMEOUT,
            Duration.ofSeconds(60), LOGGER).toMillis();
        DEFAULT_RESPONSE_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration,
            PROPERTY_TypeSpec_REQUEST_RESPONSE_TIMEOUT, Duration.ofSeconds(60), LOGGER).toMillis();
        DEFAULT_READ_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration, PROPERTY_TypeSpec_REQUEST_READ_TIMEOUT,
            Duration.ofSeconds(60), LOGGER).toMillis();
    }
     ...
     * com.typespec.core.http.HttpClient} backed by Reactor Netty.
     */
     ...
     *
     * <!-- src_embed com.typespec.core.http.netty.from-existing-http-client -->
     * <pre>
     ...
     *     .build&#40;&#41;;
     * </pre>
     * <!-- end com.typespec.core.http.netty.from-existing-http-client -->
     *
    ...
    /**
     * Creates a new Netty-backed {@link com.typespec.core.http.HttpClient} instance on every call, using the configuration
     ...
     * {@link com.typespec.core.http.HttpClient#sendSync(HttpRequest, Context)} to send the provided request synchronously
     * with contextual information.
     *
     * @return A new Netty-backed {@link com.typespec.core.http.HttpClient} instance.
     * @throws IllegalStateException If the builder is configured to use an unknown proxy type.
     */
    public com.typespec.core.http.HttpClient build() {
     ...
     *
     * <!-- src_embed com.typespec.core.http.netty.NettyAsyncHttpClientBuilder.connectionProvider#ConnectionProvider -->
     * <pre>
     ...
     *     .build&#40;&#41;;
     * </pre>
     * <!-- end com.typespec.core.http.netty.NettyAsyncHttpClientBuilder.connectionProvider#ConnectionProvider -->
     *
     ...
     *
     * <!-- src_embed com.typespec.core.http.netty.NettyAsyncHttpClientBuilder#eventLoopGroup -->
     * <pre>
     * int threadCount = 5;
     * HttpClient client = new NettyAsyncHttpClientBuilder&#40;&#41;
     ...
     *     .build&#40;&#41;;
     * </pre>
     * <!-- end com.typespec.core.http.netty.NettyAsyncHttpClientBuilder#eventLoopGroup -->
     *
     ...
     * then return.
     *
     * <!-- src_embed com.typespec.core.http.netty.disabled-buffer-copy -->
     * <pre>
     * HttpClient client = new NettyAsyncHttpClientBuilder&#40;&#41;
     *     .port&#40;8080&#41;
     ...
     *     .subscribe&#40;&#41;;
     * </pre>
     * <!-- end com.typespec.core.http.netty.disabled-buffer-copy -->
     *
     ...
     * <p>
     * If {@code connectTimeout} is null either {@link Configuration#PROPERTY_TypeSpec_REQUEST_CONNECT_TIMEOUT} or a
     ...
     * <p>
     * If {@code writeTimeout} is null either {@link Configuration#PROPERTY_TypeSpec_REQUEST_WRITE_TIMEOUT} or a 60-second
     ...
     * <p>
     * If {@code responseTimeout} is null either {@link Configuration#PROPERTY_TypeSpec_REQUEST_RESPONSE_TIMEOUT} or a
     ...
     * <p>
     * If {@code readTimeout} is null or {@link Configuration#PROPERTY_TypeSpec_REQUEST_READ_TIMEOUT} or a 60-second
    ...
    private static ProxyProvider.Proxy toReactorNettyProxyType(ProxyOptions.Type TypeSpecProxyType) {
        switch (TypeSpecProxyType) {
            case HTTP:
    ...
    /*
     * Request has started, add the TypeSpec SDK ChannelAdapter.
     */
    private static void addHandler(HttpClientRequest request, Connection connection, long writeTimeout,
        ...
        TypeSpecNettyHttpClientContext attr = request.currentContextView().getOrDefault(
            TypeSpecNettyHttpClientContext.KEY, null);

        connection.addHandlerLast(TypeSpecSdkHandler.HANDLER_NAME, new TypeSpecSdkHandler(attr, writeTimeout, responseTimeout,
            readTimeout));
    }

    /*
     * Response has completed, remove the TypeSpec SDK ChannelHandler.
     */
    private static void removeHandler(Connection connection) {
        connection.removeHandler(TypeSpecSdkHandler.HANDLER_NAME);
    }
}
