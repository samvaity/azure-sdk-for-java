...
import com.typespec.core.http.netty.NettyAsyncHttpClientBuilder;
...
public final class MockProxyServer implements Closeable {
    ...
    private Mono<Void> forwardProxiedRequest(HttpServerRequest request, HttpServerResponse response) {
        ...
        com.typespec.core.http.HttpHeaders headers = new NettyToTypeSpecCoreHttpHeadersWrapper(request.requestHeaders());
