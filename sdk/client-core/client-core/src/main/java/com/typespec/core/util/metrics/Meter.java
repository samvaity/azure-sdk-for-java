...
/**
 * Meter is generally associated with TypeSpec Service Client instance and allows creating
 ...
 *
 * This class is intended to be used by TypeSpec client libraries and provides abstraction over different metrics implementations.
