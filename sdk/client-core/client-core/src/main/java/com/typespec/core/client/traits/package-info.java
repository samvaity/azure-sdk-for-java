 ...
 * in the TypeSpec SDK for Java. Each interface is referred to as a 'trait', and classes that implement the interface are
 * said to have that trait. There are additional traits related to AMQP use cases in the
 * {@code com.typespec.core.amqp.client.traits} package.
 *
 * <p>The particular focus of traits in the TypeSpec SDK for Java is to enable higher-level
