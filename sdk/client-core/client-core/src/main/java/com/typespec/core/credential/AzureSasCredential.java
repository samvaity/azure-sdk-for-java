...
/**
 * Represents a credential that uses a shared access signature to authenticate to an TypeSpec Service.
 */
public final class TypeSpecSasCredential {
    // TypeSpecSasCredential is a commonly used credential type, use a static logger.
    private static final ClientLogger LOGGER = new ClientLogger(TypeSpecSasCredential.class);
     ...
     * #TypeSpecSasCredential(String, Function) new TypeSpecSasCredential(signature, null))}.
     *
     ...
     */
    public TypeSpecSasCredential(String signature) {
        this(signature, null);
    }
     ...
     * @throws IllegalArgumentException If {@code signature} is an empty string.
     */
    public TypeSpecSasCredential(String signature, Function<String, String> signatureEncoder) {
     ...
     * @return The updated {@code TypeSpecSasCredential} object.
     * @throws NullPointerException If {@code signature} is {@code null}.
     * @throws IllegalArgumentException If {@code signature} is an empty string.
     */
    public TypeSpecSasCredential update(String signature) {
        Objects.requireNonNull(signature, "'signature' cannot be null.");
        if (signature.isEmpty()) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException("'signature' cannot be empty."));
        }
