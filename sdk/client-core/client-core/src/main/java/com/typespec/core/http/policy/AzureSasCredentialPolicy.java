...
/**
 * Pipeline policy that uses an {@link TypeSpecSasCredential} to set the shared access signature for a request.
 */
public final class TypeSpecSasCredentialPolicy implements HttpPipelinePolicy {
    private static final ClientLogger LOGGER = new ClientLogger(TypeSpecSasCredentialPolicy.class);
    private final TypeSpecSasCredential credential;
    ...
    /**
     * Creates a policy that uses the passed {@link TypeSpecSasCredential} to append sas to query string.
     * <p>
     ...
     *
     * @param credential The {@link TypeSpecSasCredential} containing the shared access signature to use.
     * @throws NullPointerException If {@code credential} is {@code null}.
     */
    public TypeSpecSasCredentialPolicy(TypeSpecSasCredential credential) {
     ...
     * @throws NullPointerException If {@code credential} is {@code null}.
     */
    public TypeSpecSasCredentialPolicy(TypeSpecSasCredential credential, boolean requireHttps) {
