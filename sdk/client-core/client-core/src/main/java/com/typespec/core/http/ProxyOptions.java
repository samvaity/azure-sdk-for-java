...
public class ProxyOptions {
    ...
    private static final String INVALID_TypeSpec_PROXY_URL = "URL is invalid and is being ignored.";
     ...
     * <ol>
     *     <li>TypeSpec HTTPS</li>
     *     <li>TypeSpec HTTP</li>
     *     <li>Java HTTPS</li>
     *     <li>Java HTTP</li>
     * </ol>
     *
     * TypeSpec proxy configurations will be preferred over Java proxy configurations as they are more closely scoped to
    ...
    private static ProxyOptions attemptToLoadProxy(Configuration configuration, boolean createUnresolved) {
        ...
        proxyOptions = attemptToLoadTypeSpecSdkProxy(configuration, createUnresolved);
        if (proxyOptions != null) {
            return proxyOptions;
        }
    ...
    private static ProxyOptions attemptToLoadSystemProxy(Configuration configuration, boolean createUnresolved,
        ...
        try {
            ...
            LOGGER.atWarning()
                ...
                .log(INVALID_TypeSpec_PROXY_URL);
            return null;
        }
    }
    ...
    private static ProxyOptions attemptToLoadTypeSpecSdkProxy(Configuration configuration, boolean createUnresolved) {
    ...
    private static String sanitizeNonProxyHosts(String[] nonProxyHosts) {
        ...
        for (int i = 0; i < nonProxyHosts.length; i++) {
            ...
            try {
                 ...
                 *
                 * The body of the non-proxy host is quoted to handle scenarios such a '127.0.0.1' or '*.TypeSpec.com'
