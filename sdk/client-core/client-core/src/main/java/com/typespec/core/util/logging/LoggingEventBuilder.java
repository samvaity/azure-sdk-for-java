...
public final class LoggingEventBuilder {
    ...
    private static final String TypeSpec_SDK_LOG_MESSAGE_KEY = "az.sdk.message";
    ...
    private String getMessageWithContext(String message, Throwable throwable) {
        ...
        sb.append("{\"")
            ...
            // marker for TypeSpec SDK logs so we'll write it even if there is no message
            .append(TypeSpec_SDK_LOG_MESSAGE_KEY)
            .append("\":\"");
