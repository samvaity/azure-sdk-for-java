...
import com.typespec.core.http.rest.PagedFlux;
import com.typespec.core.http.rest.Response;
import com.typespec.core.implementation.AsynchronousByteChannelWriteSubscriber;
import com.typespec.core.implementation.ByteBufferCollector;
import com.typespec.core.implementation.OutputStreamWriteSubscriber;
import com.typespec.core.implementation.RetriableDownloadFlux;
...
public final class FluxUtil {
     ...
     * Context} to {@link Context TypeSpec Context} and calls the given lambda function with this context and returns a
     ...
     * <!-- src_embed com.typespec.core.implementation.util.fluxutil.withcontext -->
     * <pre>
     * String prefix = &quot;Hello, &quot;;
     * Mono&lt;String&gt; response = FluxUtil
     *     .withContext&#40;context -&gt; serviceCallReturnsSingle&#40;prefix, context&#41;&#41;;
     * </pre>
     * <!-- end com.typespec.core.implementation.util.fluxutil.withcontext -->
     *
     * @param serviceCall The lambda function that makes the service call into which TypeSpec context will be passed
    ...
    /**
     * This method converts the incoming {@code deferContextual} from {@link reactor.util.context.Context Reactor
     * Context} to {@link Context TypeSpec Context}, adds the specified context attributes and calls the given lambda
     * function with this context and returns a single entity of type {@code T}
     * <p>
     * If the reactor context is empty, {@link Context#NONE} will be used to call the lambda function
     * </p>
     *
     * @param serviceCall serviceCall The lambda function that makes the service call into which TypeSpec context will be
     * passed
    ...
    public static <T> Mono<T> withContext(Function<Context, Mono<T>> serviceCall,
        ...
        return Mono.deferContextual(context -> {
            final Context[] TypeSpecContext = new Context[]{Context.NONE};

            if (!CoreUtils.isNullOrEmpty(contextAttributes)) {
                contextAttributes.forEach((key, value) -> TypeSpecContext[0] = TypeSpecContext[0].addData(key, value));
            }

            if (!context.isEmpty()) {
                context.stream().forEach(entry ->
                    TypeSpecContext[0] = TypeSpecContext[0].addData(entry.getKey(), entry.getValue()));
            }

            return serviceCall.apply(TypeSpecContext[0]);
        });
    }
     ...
     *
     * <p><strong>Code samples</strong></p>
     * <!-- src_embed com.typespec.core.implementation.util.fluxutil.fluxcontext -->
     * <pre>
     * String prefix = &quot;Hello, &quot;;
     * Flux&lt;String&gt; response = FluxUtil
     *     .fluxContext&#40;context -&gt; serviceCallReturnsCollection&#40;prefix, context&#41;&#41;;
     * </pre>
     * <!-- end com.typespec.core.implementation.util.fluxutil.fluxcontext -->
     *
    ...
    public static <T> Flux<T> fluxContext(Function<Context, Flux<T>> serviceCall) {
        return Flux.deferContextual(context -> serviceCall.apply(toTypeSpecContext(context)));
    }

    /**
     * Converts a reactor context to TypeSpec context. If the reactor context is {@code null} or empty, {@link
     * Context#NONE} will be returned.
     *
     * @param context The reactor context
     * @return The TypeSpec context
     */
    private static Context toTypeSpecContext(ContextView context) {
        final Context[] TypeSpecContext = new Context[]{Context.NONE};
        ...
        return TypeSpecContext[0];
    }

    /**
     * Converts an TypeSpec context to Reactor context. If the TypeSpec context is {@code null} or empty, {@link
