...
/**
 * The default synchronous polling strategy to use with TypeSpec data plane services. The default polling strategy will
 ...
 * will be used. The created chained polling strategy is capable of handling most of the polling scenarios in TypeSpec.
 *
