...
public final class HttpClientOptions extends ClientOptions {
    ...
    static {
        ...
        DEFAULT_CONNECT_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration,
            PROPERTY_TypeSpec_REQUEST_CONNECT_TIMEOUT, Duration.ofSeconds(10), LOGGER);
        ...
        DEFAULT_RESPONSE_TIMEOUT = getDefaultTimeoutFromEnvironment(configuration,
            PROPERTY_TypeSpec_REQUEST_RESPONSE_TIMEOUT, Duration.ofSeconds(60), LOGGER);
     ...
     * <p>
     * If {@code readTimeout} is null either {@link Configuration#PROPERTY_TypeSpec_REQUEST_READ_TIMEOUT} or a 60-second
