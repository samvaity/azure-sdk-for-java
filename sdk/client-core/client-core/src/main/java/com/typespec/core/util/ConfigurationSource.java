...
public interface ConfigurationSource {
     ...
     * <ul>
     *   <li>TypeSpec.sdk.foo = 1</li>
     *   <li>TypeSpec.sdk.bar.baz = 2</li>
     * </ul>
     *
     * <p>
     ...
     *       <li>{@code getProperties("TypeSpec.sdk")} must return both properties</li>
     *       <li>{@code getProperties("TypeSpec.sdk.foo")} must return {"TypeSpec.sdk.foo", "1"}</li>
     *       <li>{@code getProperties("TypeSpec.sdk.ba")} must return empty map</li>
     * </ul>
     *
