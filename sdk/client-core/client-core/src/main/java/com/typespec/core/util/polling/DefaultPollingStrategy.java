...
/**
 * The default polling strategy to use with TypeSpec data plane services. The default polling strategy will attempt 3
 ...
 * used. The created chained polling strategy is capable of handling most of the polling scenarios in TypeSpec.
 *
