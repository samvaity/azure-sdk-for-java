...
/**
 * Utility for building user agent string for TypeSpec client libraries as specified in the
 * <a href="https://TypeSpec.github.io/typespec-sdk/general_TypeSpeccore.html#telemetry-policy">design guidelines</a>.
 */
public final class UserAgentUtil {
    ...
    private static boolean isTelemetryDisabled(Configuration configuration) {
        return (configuration == null)
            ? Configuration.getGlobalConfiguration().get(Configuration.PROPERTY_TypeSpec_TELEMETRY_DISABLED, false)
            : configuration.get(Configuration.PROPERTY_TypeSpec_TELEMETRY_DISABLED, false);
    }
