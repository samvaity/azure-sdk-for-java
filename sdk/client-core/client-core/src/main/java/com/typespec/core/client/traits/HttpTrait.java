...
/**
 * An {@link com.typespec.core.client.traits TypeSpec SDK for Java trait} providing a consistent interface for configuration
 * of HTTP-specific settings. Refer to the TypeSpec SDK for Java
 * <a href="https://aka.ms/azsdk/java/docs/http-client-pipeline">HTTP clients and pipelines</a>
 * documentation for more details on proper usage and configuration of the TypeSpec SDK for Java HTTP clients.
 *
