...
import static com.typespec.core.util.Configuration.PROPERTY_TypeSpec_HTTP_CLIENT_IMPLEMENTATION;
...
public final class HttpClientProviders {
    private static final String NO_DEFAULT_PROVIDER_MESSAGE = "A request was made to load the default HttpClient provider "
        ...
        + "dependency on typespec-core-http-netty or typespec-core-http-okhttp. Depending on your existing dependencies, you "
    ...
    private static final Providers<HttpClientProvider, HttpClient> HTTP_CLIENT_PROVIDERS = new Providers<>(HttpClientProvider.class,
        Configuration.getGlobalConfiguration().get(PROPERTY_TypeSpec_HTTP_CLIENT_IMPLEMENTATION),
