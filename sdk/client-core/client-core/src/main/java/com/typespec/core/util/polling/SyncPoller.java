...
/**
 * A type that offers API that simplifies the task of executing long-running operations against an TypeSpec service.
 *
 * <p>
...
public interface SyncPoller<T, U> {
     ...
     * {@link PollingContext}.
     * @param strategy a known syncrhonous strategy for polling a long-running operation in TypeSpec
