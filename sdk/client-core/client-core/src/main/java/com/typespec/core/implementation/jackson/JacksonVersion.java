...
final class JacksonVersion {
    ...
    private static final String TypeSpec_CORE_PROPERTIES_NAME = "typespec-core.properties";
    private static final String TypeSpec_CORE_PROPERTIES_VERSION_KEY = "version";

    private static final String TypeSpec_CORE_VERSION = CoreUtils.getProperties(TypeSpec_CORE_PROPERTIES_NAME)
        .getOrDefault(TypeSpec_CORE_PROPERTIES_VERSION_KEY, SemanticVersion.UNKNOWN_VERSION);
    ...
    static {
        ...
        HELP_STRING = "Package versions: "
            ...
            + "typespec-core=" + TypeSpec_CORE_VERSION + ", "
