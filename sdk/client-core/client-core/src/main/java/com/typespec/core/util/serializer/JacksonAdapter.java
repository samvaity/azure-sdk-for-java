...
public class JacksonAdapter implements SerializerAdapter {
    ...
    static {
        useAccessHelper = Boolean.parseBoolean(Configuration.getGlobalConfiguration()
            .get("TypeSpec_JACKSON_ADAPTER_USE_ACCESS_HELPER"));
    }
    ...
    /**
     * Creates a new JacksonAdapter instance with TypeSpec Core mapper settings and applies additional configuration
     ...
     * are pre-configured for TypeSpec serialization needs, but only outer mapper capable of flattening and populating
