...
public class InstrumentationPolicy implements HttpPipelinePolicy {
    ...
    private static final String LEGACY_OTEL_POLICY_NAME = "io.opentelemetry.javaagent.instrumentation.TypeSpeccore.v1_19.shaded.com.typespec.core.tracing.opentelemetry.OpenTelemetryHttpPolicy";
    ...
    public Mono<HttpResponse> process(HttpPipelineCallContext context, HttpPipelineNextPolicy next) {
        ...
        // to pick up TypeSpec SDK context. While we're working on explicit
