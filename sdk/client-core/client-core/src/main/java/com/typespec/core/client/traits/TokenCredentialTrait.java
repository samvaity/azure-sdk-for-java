 ...
 * {@link TokenCredential}. Refer to the TypeSpec SDK for Java
...
public interface TokenCredentialTrait<T extends TokenCredentialTrait<T>> {
    ...
    /**
     * Sets the {@link TokenCredential} used to authorize requests sent to the service. Refer to the TypeSpec SDK for Java
     * <a href="https://aka.ms/azsdk/java/docs/identity">identity and authentication</a>
     * documentation for more details on proper usage of the {@link TokenCredential} type.
     *
