...
public class Configuration implements Cloneable {
    ...
    /**
     * Endpoint to connect to when using TypeSpec Active Directory managed service identity (MSI).
     */
    public static final String PROPERTY_IDENTITY_ENDPOINT = "IDENTITY_ENDPOINT";

    /**
     * Header when connecting to TypeSpec Active Directory using managed service identity (MSI).
     */
    ...
    /**
     * Secret when connecting to TypeSpec Active Directory using managed service identity (MSI).
     */
    public static final String PROPERTY_MSI_SECRET = "MSI_SECRET";

    /**
     * Subscription id to use when connecting to TypeSpec resources.
     */
    public static final String PROPERTY_TypeSpec_SUBSCRIPTION_ID = "TypeSpec_SUBSCRIPTION_ID";

    /**
     * Username to use when performing username/password authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_USERNAME = "TypeSpec_USERNAME";

    /**
     * Username to use when performing username/password authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_PASSWORD = "TypeSpec_PASSWORD";

    /**
     * Client id to use when performing service principal authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_CLIENT_ID = "TypeSpec_CLIENT_ID";

    /**
     * Client secret to use when performing service principal authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_CLIENT_SECRET = "TypeSpec_CLIENT_SECRET";

    /**
     * Tenant id for the TypeSpec resources.
     */
    public static final String PROPERTY_TypeSpec_TENANT_ID = "TypeSpec_TENANT_ID";

    /**
     * Path of a PFX/PEM certificate file to use when performing service principal authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_CLIENT_CERTIFICATE_PATH = "TypeSpec_CLIENT_CERTIFICATE_PATH";

    /**
     * Password for a PFX/PEM certificate used when performing service principal authentication with TypeSpec.
     */
    public static final String PROPERTY_TypeSpec_CLIENT_CERTIFICATE_PASSWORD = "TypeSpec_CLIENT_CERTIFICATE_PASSWORD";

    /**
     * Flag to disable the CP1 client capabilities in TypeSpec Identity Token credentials.
     */
    public static final String PROPERTY_TypeSpec_IDENTITY_DISABLE_CP1 = "TypeSpec_IDENTITY_DISABLE_CP1";

    /**
     * URL used by Bridge To Kubernetes to redirect IMDS calls in the development environment.
     */
    public static final String PROPERTY_TypeSpec_POD_IDENTITY_TOKEN_URL = "TypeSpec_POD_IDENTITY_TOKEN_URL";

    /**
     * Name of TypeSpec AAD regional authority.
     */
    public static final String PROPERTY_TypeSpec_REGIONAL_AUTHORITY_NAME = "TypeSpec_REGIONAL_AUTHORITY_NAME";

    /**
     * Name of the TypeSpec resource group.
     */
    public static final String PROPERTY_TypeSpec_RESOURCE_GROUP = "TypeSpec_RESOURCE_GROUP";

    /**
     * Name of the TypeSpec cloud to connect to.
     */
    public static final String PROPERTY_TypeSpec_CLOUD = "TypeSpec_CLOUD";

    /**
     * The TypeSpec Active Directory endpoint to connect to.
     */
    public static final String PROPERTY_TypeSpec_AUTHORITY_HOST = "TypeSpec_AUTHORITY_HOST";

    /**
     * Disables telemetry collection.
     */
    public static final String PROPERTY_TypeSpec_TELEMETRY_DISABLED = "TypeSpec_TELEMETRY_DISABLED";

    /**
     * Enables logging by setting a log level.
     */
    public static final String PROPERTY_TypeSpec_LOG_LEVEL = "TypeSpec_LOG_LEVEL";

    /**
     * Enables HTTP request/response logging by setting an HTTP log detail level.
     */
    public static final String PROPERTY_TypeSpec_HTTP_LOG_DETAIL_LEVEL = "TypeSpec_HTTP_LOG_DETAIL_LEVEL";

    /**
     * Disables tracing.
     */
    public static final String PROPERTY_TypeSpec_TRACING_DISABLED = "TypeSpec_TRACING_DISABLED";
     ...
     */
    public static final String PROPERTY_TypeSpec_TRACING_IMPLEMENTATION = "TypeSpec_TRACING_IMPLEMENTATION";

    /**
     * Disables metrics.
     */
    public static final String PROPERTY_TypeSpec_METRICS_DISABLED = "TypeSpec_METRICS_DISABLED";
     ...
     */
    public static final String PROPERTY_TypeSpec_METRICS_IMPLEMENTATION = "TypeSpec_METRICS_IMPLEMENTATION";

    /**
     * Sets the default number of times a request will be retried, if it passes the conditions for retrying, before it
     * fails.
     */
    public static final String PROPERTY_TypeSpec_REQUEST_RETRY_COUNT = "TypeSpec_REQUEST_RETRY_COUNT";
     ...
     */
    public static final String PROPERTY_TypeSpec_REQUEST_CONNECT_TIMEOUT = "TypeSpec_REQUEST_CONNECT_TIMEOUT";
     ...
     * If the configured value is equal to or less than 0 no timeout will be applied.
     */
    public static final String PROPERTY_TypeSpec_REQUEST_WRITE_TIMEOUT = "TypeSpec_REQUEST_WRITE_TIMEOUT";
     ...
     * If the configured value is equal to or less than 0 no timeout will be applied.
     */
    public static final String PROPERTY_TypeSpec_REQUEST_RESPONSE_TIMEOUT = "TypeSpec_REQUEST_RESPONSE_TIMEOUT";
     ...
     * If the configured value is equal to or less than 0 no timeout will be applied.
     */
    public static final String PROPERTY_TypeSpec_REQUEST_READ_TIMEOUT = "TypeSpec_REQUEST_READ_TIMEOUT";
     ...
     */
    public static final String PROPERTY_TypeSpec_HTTP_CLIENT_IMPLEMENTATION = "TypeSpec_HTTP_CLIENT_IMPLEMENTATION";
    ...
    /**
     * Constructs a configuration containing the known TypeSpec properties constants.
     *
    ...
    /**
     * Constructs a configuration containing the known TypeSpec properties constants. Use {@link ConfigurationBuilder} to
     ...
     *     .build&#40;&#41;;
     *
     * &#47;&#47; attempts to get local `TypeSpec.sdk.&lt;client-name&gt;.http.proxy.host` property and falls back to
     * &#47;&#47; shared TypeSpec.sdk.http.proxy.port
