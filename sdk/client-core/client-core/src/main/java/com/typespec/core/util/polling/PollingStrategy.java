...
/**
 * Represents a known strategy for polling a long-running operation in TypeSpec.
 *
 * <p>
 *
 * The methods in the polling strategy will be invoked from the {@link com.typespec.core.util.polling.PollerFlux}. The
 ...
 * TypeSpec. When there are special scenarios, built-in polling strategies can be inherited and select methods can be
