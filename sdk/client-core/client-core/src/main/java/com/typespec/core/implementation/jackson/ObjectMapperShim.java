...
public final class ObjectMapperShim {
    ...
    /**
     * Creates and configures JSON {@code ObjectMapper} capable of serializing TypeSpec.core types, with flattening and
     * additional properties support.
     *
     * @param innerMapperShim inner mapper to use for non-TypeSpec specific serialization.
    ...
    /**
     * Creates and configures XML {@code ObjectMapper} capable of serializing TypeSpec.core types.
     *
     * @return Instance of shimmed {@code ObjectMapperShim}.
     */
