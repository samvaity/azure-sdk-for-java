 ...
 * they are in beta.
 * <p>
 * Once {@code typespec-json} and {@code typespec-xml} GA this can be replaced with direct usage of the types. This is
        ...
        try {
            ...
            if (e instanceof LinkageError || e instanceof Exception) {
                LOGGER.log(LogLevel.VERBOSE, () -> "XmlSerializable serialization and deserialization isn't supported. "
                    + "If it is required add a dependency of 'com.typespec:typespec-xml', or another dependencies which "
                    + "include 'com.typespec:typespec-xml' as a transitive dependency. If your application runs as expected "
