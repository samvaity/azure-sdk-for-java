 ...
 *
 * <!-- src_embed com.typespec.core.http.HttpPipelineBuilder.noConfiguration -->
 * <pre>
 ...
 *
 * <!-- src_embed com.typespec.core.http.HttpPipelineBuilder.defaultHttpClientWithRetryPolicy -->
 * <pre>
...
public class HttpPipelineBuilder {
    ...
    private void configureTracing(List<HttpPipelinePolicy> policies) {
        if (tracer == null) {
            ...
            tracer = TracerProvider.getDefaultProvider().createTracer("typespec-core", null, null, tracingOptions);
        }
