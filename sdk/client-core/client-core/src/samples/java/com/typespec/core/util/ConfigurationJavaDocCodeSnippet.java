...
public class ConfigurationJavaDocCodeSnippet {
    ...
    public void configurationBuilderUsage() {
        ...
        properties.put("TypeSpec.sdk.client-name.http.proxy.port", "8080");
        properties.put("TypeSpec.sdk.http.proxy.hostname", "<host");
        properties.put("TypeSpec.sdk.http.proxy.username", "user");
        properties.put("TypeSpec.sdk.http.proxy.password", "pwd");
    ...
    public void configurationPropertyUsage() {
        Map<String, String> properties = new HashMap<>();
        properties.put("TypeSpec.sdk.sample.timeout", "1000");
        properties.put("TypeSpec.sdk.sample.retry-count", "3");
        properties.put("TypeSpec.sdk.sample.is-enabled", "true");
        properties.put("TypeSpec.sdk.sample.mode", "mode1");
