...
import com.typespec.core.util.MetricsOptions;
...
/**
 * Contains code snippets for {@link Meter} showing how to use it in TypeSpec client libraries.
 */
public class MetricsJavaDocCodeSnippets {
    final MeterProvider meterProvider = MeterProvider.getDefaultProvider();
    final Meter defaultMeter = meterProvider.createMeter("typespec-core-metrics-samples", "1.0.0", null);
    /**
    ...
    public void createMeter() {
        ...
        Meter meter = MeterProvider.getDefaultProvider().createMeter("typespec-core", "1.0.0", metricsOptions);
    ...
    public void createCounter() {
        ...
        TelemetryAttributes attributes = defaultMeter.createAttributes(new HashMap<String, Object>() {{
                put("endpoint", "http://service-endpoint.TypeSpec.com");
                put("status", "ok");
            }});
    ...
    public void createHistogram() {
        ...
        Meter meter = meterProvider
            .createMeter("typespec-core", "1.0.0", new MetricsOptions());
        ...
        TelemetryAttributes attributes = defaultMeter.createAttributes(
            Collections.singletonMap("endpoint", "http://service-endpoint.TypeSpec.com"));
