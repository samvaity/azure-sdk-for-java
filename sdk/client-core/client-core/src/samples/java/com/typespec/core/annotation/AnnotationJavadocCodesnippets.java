...
/**
 * Javadoc codesnippets for {@link com.typespec.core.annotation} classes.
 */
...
public interface AnnotationJavadocCodesnippets {
    ...
    interface BodyParamExamples {
        // BEGIN: com.typespec.core.annotation.BodyParam.class1
        ...
        // BEGIN: com.typespec.core.annotation.BodyParam.class2
    ...
    interface DeleteExamples {
        // BEGIN: com.typespec.core.annotation.Delete.class1
        ...
        void delete(@PathParam("resourceGroupName") String rgName,
            @PathParam("vmName") String vmName,
            @PathParam("subscriptionId") String subscriptionId);
        // END: com.typespec.core.annotation.Delete.class1

        // BEGIN: com.typespec.core.annotation.Delete.class2
        @Delete("{vaultBaseUrl}/secrets/{secretName}")
        void delete(@PathParam(value = "vaultBaseUrl", encoded = true) String vaultBaseUrl,
            @PathParam("secretName") String secretName);
        // END: com.typespec.core.annotation.Delete.class2
    }
    ...
    interface ExpectedResponsesExamples {
        // BEGIN: com.typespec.core.annotation.ExpectedResponses.class
        ...
        // END: com.typespec.core.annotation.ExpectedResponses.class
    }
    ...
    interface FormParamExamples {
        // BEGIN: com.typespec.core.annotation.FormParam.class
        @Post("spellcheck")
    ...
    interface GetExamples {
        // BEGIN: com.typespec.core.annotation.Get.class1
        ...
        VirtualMachine getByResourceGroup(@PathParam("resourceGroupName") String rgName,
            @PathParam("vmName") String vmName,
            @PathParam("subscriptionId") String subscriptionId);
        // END: com.typespec.core.annotation.Get.class1

        // BEGIN: com.typespec.core.annotation.Get.class2
        @Get("{nextLink}")
        List<VirtualMachine> listNext(@PathParam("nextLink") String nextLink);
        // END: com.typespec.core.annotation.Get.class2
    }
    ...
    interface HeadExamples {
        // BEGIN: com.typespec.core.annotation.Head.class1
        ...
        boolean checkNameAvailability(@PathParam("resourceGroupName") String rgName,
            @PathParam("vmName") String vmName,
            @PathParam("subscriptionId") String subscriptionId);
        // END: com.typespec.core.annotation.Head.class1

        // BEGIN: com.typespec.core.annotation.Head.class2
        @Head("{storageAccountId}")
        boolean checkNameAvailability(@PathParam("storageAccountId") String storageAccountId);
        // END: com.typespec.core.annotation.Head.class2
    }
    ...
    interface HeaderParamExamples {
        // BEGIN: com.typespec.core.annotation.HeaderParam.class1
        @Put("{functionId}")
        ...
        // BEGIN: com.typespec.core.annotation.HeaderParam.class2
        ...
        // BEGIN: com.typespec.core.annotation.HeaderParam.class3
        @Get("subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/namespaces")
        Mono<ResponseBase<ResponseHeaders, ResponseBody>> list(@PathParam("subscriptionId") String subscriptionId,
        ...
        // BEGIN: com.typespec.core.annotation.HeaderParam.class4
    ...
    interface HeadersExamples {
        // BEGIN: com.typespec.core.annotation.Headers.class
    ...
    interface HostExamples {
        // BEGIN: com.typespec.core.annotation.Host.class1
        @Host("https://management.TypeSpec.com")
        ...
        // BEGIN: com.typespec.core.annotation.Host.class2
        @Host("https://{vaultName}.vault.TypeSpec.net:443")
     ...
     */
    // BEGIN: com.typespec.core.annotation.HostParam.class1
    ...
    // END: com.typespec.core.annotation.HostParam.class1

    /**
     * Examples for {@link HostParam}.
     */
    // BEGIN: com.typespec.core.annotation.HostParam.class2
    ...
    // END: com.typespec.core.annotation.HostParam.class2
    ...
    interface OptionsExamples {
        // BEGIN: com.typespec.core.annotation.Options.class1
        ...
        // BEGIN: com.typespec.core.annotation.Options.class2
    ...
    interface PatchExamples {
        // BEGIN: com.typespec.core.annotation.Patch.class1
        ...
        // END: com.typespec.core.annotation.Patch.class1

        // BEGIN: com.typespec.core.annotation.Patch.class2
        ...
        // END: com.typespec.core.annotation.Patch.class2
    }
    ...
    interface PathParamExamples {
        // BEGIN: com.typespec.core.annotation.PathParam.class1
        @Get("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/"
            + "virtualMachines/")
        ...
        // END: com.typespec.core.annotation.PathParam.class1

        // BEGIN: com.typespec.core.annotation.PathParam.class2
        ...
        // END: com.typespec.core.annotation.PathParam.class2

        // BEGIN: com.typespec.core.annotation.PathParam.class3
        ...
        // END: com.typespec.core.annotation.PathParam.class3
    }
    ...
    interface PostExamples {
        // BEGIN: com.typespec.core.annotation.Post.class1
        ...
        void restart(@PathParam("resourceGroupName") String rgName,
            @PathParam("vmName") String vmName,
            @PathParam("subscriptionId") String subscriptionId);
        // END: com.typespec.core.annotation.Post.class1

        // BEGIN: com.typespec.core.annotation.Post.class2
        @Post("https://{functionApp}.TypeSpecwebsites.net/admin/functions/{name}/keys/{keyName}")
        KeyValuePair generateFunctionKey(@PathParam("functionApp") String functionApp,
            @PathParam("name") String name,
            @PathParam("keyName") String keyName);
        // END: com.typespec.core.annotation.Post.class2
    }
    ...
    interface PutExamples {
        // BEGIN: com.typespec.core.annotation.Put.class1
        @Put("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/"
            + "virtualMachines/{vmName}")
        VirtualMachine createOrUpdate(@PathParam("resourceGroupName") String rgName,
            @PathParam("vmName") String vmName,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") VirtualMachine vm);
        // END: com.typespec.core.annotation.Put.class1

        // BEGIN: com.typespec.core.annotation.Put.class2
        ...
        // END: com.typespec.core.annotation.Put.class2
    }
    ...
    interface QueryParamExamples {
        // BEGIN: com.typespec.core.annotation.QueryParam.class1
        ...
        // BEGIN: com.typespec.core.annotation.QueryParam.class2
        ...
        // BEGIN: com.typespec.core.annotation.QueryParam.class3
        @Get("http://wq.com/foo/{subpath}/values")
        ...
        // BEGIN: com.typespec.core.annotation.QueryParam.class4
    ...
    interface UnexpectedResponseExceptionTypeExamples {
        // BEGIN: com.typespec.core.annotation.UnexpectedResponseExceptionType.class
