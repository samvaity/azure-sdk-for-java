...
/**
 * Tests {@link TypeSpecSasCredential}.
 */
public class TypeSpecSasCredentialTests {
    @ParameterizedTest
    ...
    public void invalidConstructorParameters(String signature, Class<? extends Throwable> expectedException) {
        assertThrows(expectedException, () -> new TypeSpecSasCredential(signature));
        assertThrows(expectedException, () -> new TypeSpecSasCredential(signature, String::toString));
    }
    ...
    public void constructorWithoutEncodingFunctionReturnsSignatureAsIs() {
        ...
        TypeSpecSasCredential credential = new TypeSpecSasCredential(signature, null);
        assertEquals(signature, credential.getSignature());
    }
    ...
    public void constructorEncodesSignature() {
        ...
        TypeSpecSasCredential credential = new TypeSpecSasCredential(signature, sig -> sig.replaceAll(" ", "%20"));
    ...
    public void credentialWithoutEncodingFunctionDoesNotEncodeUpdates() {
        ...
        TypeSpecSasCredential credential = new TypeSpecSasCredential(signature).update(updatedSignature);
