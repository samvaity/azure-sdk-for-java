...
- Fixed a bug when buffering JSON where text fields weren't maintaining proper encoding. ([#33406](https://github.com/TypeSpec/typespec-sdk-for-java/pull/33406))
