...
public final class MultiSlotAsyncClient {
     ...
     */
    MultiSlotAsyncClient(MultiSlotsImpl serviceClient) {
    ...
    public Mono<Response<MultiSlotRankResponse>> rankWithResponse(MultiSlotRankRequest body) {
        return this.serviceClient.rankWithResponseAsync(body);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MultiSlotRankResponse> rank(MultiSlotRankRequest body) {
        return this.serviceClient.rankAsync(body);
    }
}
