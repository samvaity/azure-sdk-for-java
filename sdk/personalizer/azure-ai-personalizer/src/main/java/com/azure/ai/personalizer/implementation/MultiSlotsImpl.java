...
public final class MultiSlotsImpl {
     ...
     */
    MultiSlotsImpl(PersonalizerClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PersonalizerClientMultiSlots to be used by the proxy service to
     * perform REST calls.
     */
