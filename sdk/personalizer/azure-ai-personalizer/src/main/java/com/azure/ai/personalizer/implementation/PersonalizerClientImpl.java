...
/** Initializes a new instance of the PersonalizerClient type. */
public final class PersonalizerClientImpl {
    /** The proxy service used to perform REST calls. */
    private final PersonalizerClientService service;
     ...
     */
    public PersonalizerClientImpl(String endpoint) {
        this(
     ...
     * @param endpoint Supported Cognitive Services endpoint.
     */
    public PersonalizerClientImpl(HttpPipeline httpPipeline, String endpoint) {
     ...
     * @param endpoint Supported Cognitive Services endpoint.
     */
    public PersonalizerClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint) {
        ...
        this.service =
                RestProxy.create(PersonalizerClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for PersonalizerClient to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{Endpoint}/personalizer/v1.1-preview.3")
    @ServiceInterface(name = "PersonalizerClient")
    public interface PersonalizerClientService {
        @Post("/rank")
