...
/** The BuildModelHeaders model. */
@Fluent
public final class BuildModelHeaders {
    /*
     ...
     * @return the BuildModelHeaders object itself.
     */
    public BuildModelHeaders setOperationLocation(String operationLocation) {
