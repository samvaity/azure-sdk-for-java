...
/** The CopyModelHeaders model. */
@Fluent
public final class CopyModelHeaders {
    /*
     ...
     * @return the CopyModelHeaders object itself.
     */
    public CopyModelHeaders setOperationLocation(String operationLocation) {
