 ...
 */
public class HeaderRegexSanitizer extends TestProxySanitizer implements RegexSanitizer {
     ...
     */
    public HeaderRegexSanitizer(String regex, String replacementText) {
     ...
     * @return the {@link HeaderRegexSanitizer} itself.
     */
    public HeaderRegexSanitizer setGroupForReplace(String groupForReplace) {
