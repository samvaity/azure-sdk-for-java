...
import static com.azure.core.test.TestBase.includeHttpClientOrHttpClientProvider;
...
public final class TestTemplateExtension implements TestTemplateInvocationContextProvider {
    ...
    public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(
        ...
        Object[] httpClientsToTest = new Object[10];
        int i = 0;
        for (HttpClientProvider httpClientProvider : ServiceLoader.load(HttpClientProvider.class)) {
            if (includeHttpClientOrHttpClientProvider(httpClientProvider.getClass().getSimpleName()
                ...
                httpClientsToTest[++i] = httpClientProvider.createInstance();
            }
        }
    ...
    private final class SyncAsyncTestTemplateInvocationContext implements TestTemplateInvocationContext {
        ...
        public String getDisplayName(int invocationIndex) {
            return Arrays.toString(httpClients);
        }
    ...
    class CartesianProductResolver implements ParameterResolver {
        ...
        CartesianProductResolver(Object[] httpClients) {
            this.httpClients = httpClients;
        }

        @Override
        public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) {
            return parameterContext.getIndex() < httpClients.length;
        }

        @Override
        public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) {
            return httpClients[parameterContext.getIndex()];
        }
