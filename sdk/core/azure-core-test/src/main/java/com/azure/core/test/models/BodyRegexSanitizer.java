 ...
 */
public class BodyRegexSanitizer extends TestProxySanitizer implements RegexSanitizer {
     ...
     */
    public BodyRegexSanitizer(String regex, String replacementText) {
     ...
     * @return the {@link BodyRegexSanitizer} itself.
     */
    public BodyRegexSanitizer setGroupForReplace(String groupForReplace) {
