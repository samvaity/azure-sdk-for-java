...
**Current list**: `2025-09-01`, `2024-07-01`, `2023-11-01`, `2020-06-30`
...
```
[ ] mvn clean compile -- resolve all errors
...
1. Identify the problem (run `mvn clean compile`, note errors or unwanted public API)
2. Write the method in SearchCustomizations.java using `ClassCustomization.customizeAst()`
3. Call it from `customize()` method
4. Regenerate (`tsp-client update`) to apply
