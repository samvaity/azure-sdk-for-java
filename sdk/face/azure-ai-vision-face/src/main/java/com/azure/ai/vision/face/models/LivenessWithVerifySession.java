...
public final class LivenessWithVerifySession implements JsonSerializable<LivenessWithVerifySession> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("isAbuseMonitoringEnabled", this.isAbuseMonitoringEnabled);
    ...
    public static LivenessWithVerifySession fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Boolean isAbuseMonitoringEnabled = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sessionId".equals(fieldName)) {
                    ...
                    isAbuseMonitoringEnabled = reader.getNullable(JsonReader::getBoolean);
     ...
     */
    @Generated
    private Boolean isAbuseMonitoringEnabled;
     ...
     */
    @Generated
    public Boolean isAbuseMonitoringEnabled() {
