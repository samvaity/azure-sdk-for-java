...
public class ExponentialBackoffTest {
    ...
    public void testNullBaseDelay() {
        assertThrows(NullPointerException.class, () -> new ExponentialBackoff(new ExponentialBackoffOptions()
            .setMaxRetries(3).setBaseDelay(null).setMaxDelay(Duration.ofMillis(1000))));
    }

    @Test
    public void testNullMaxDelay() {
        assertThrows(NullPointerException.class, () -> new ExponentialBackoff(new ExponentialBackoffOptions()
            .setMaxRetries(3).setBaseDelay(Duration.ofSeconds(1)).setBaseDelay(null)));
    }
