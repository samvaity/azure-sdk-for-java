...
| **Phase 3** | ✅ Validate — run vally lint and anchor checker | [phases/03-validate.md](phases/03-validate.md) |
...
- [references/validation-tools.md](references/validation-tools.md) — vally lint, anchor checker, CI workflow setup
- [references/examples.md](references/examples.md) — Links to working examples across languages
